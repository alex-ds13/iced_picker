...
where
    Message: Clone + 'a,
    Theme: Catalog + iced::widget::button::Catalog + crate::color::Catalog,
    'b: 'a,
{
    ...
    'b: 'a,
{
    fn layout(&mut self, renderer: &Renderer, bounds: Size) -> Node {
        ...
        //         .push(Row::new().width(Length::Fill).height(Length::Fill))
        //         .layout(&mut self.state.tree[2], renderer, &limits)
        // } else {
...
//                 .height(Length::FillPortion(1)),
//         )
//         .layout(&mut color_picker.state.tree[2], renderer, &block1_limits);
//
...
//         ))
//         .layout(&mut color_picker.state.tree[2], renderer, &hex_text_limits);
//
...
//     let rgba_tree = if let Some(child_tree) = color_picker.state.tree[2].children.get_mut(0) {
//         child_tree.diff(element.as_widget());
//         child_tree
//     } else {
//         let child_tree = Tree::new(element.as_widget());
//         color_picker.state.tree[2].children.insert(0, child_tree);
//         &mut color_picker.state.tree[2].children[0]
//     };
//
